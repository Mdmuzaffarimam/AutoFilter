...
async def check_alive(_, message):
    sticker = await message.reply_sticker("CAACAgUAAxkBAAEPdxho2ShW0AmVM7K-CBffznAmvvfabwACzh0AAuCZEVUO8IoE_LMrNzYE") 
    text = await message.reply_text("Yᴏᴜ ᴀʀᴇ ᴠᴇʀʏ Mrn_Officialx 🤞 I ᴀᴍ ᴀʟɪᴠᴇ ❤️\nPʀᴇss /start ᴛᴏ ᴜsᴇ ᴍᴇ!")
